...
def pickle_dump(obj,fpath):
	#Alec edit:
	#Attempt to reduce the memory needed to dump to a pickle since windows is stingy with memory
	#Also update the pickle to use highest protocol which should have storage benefits.
	pass
